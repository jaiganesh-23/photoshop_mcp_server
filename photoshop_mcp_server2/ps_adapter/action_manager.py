...
class ActionManager:
    ...
    def get_active_document_info(cls) -> dict[str, Any]:
        ...
        try:
            ...
            # Use app.activeDocument.width and height for correct values
            try:
                active_doc = app.activeDocument
                result["width"] = float(active_doc.width)
                result["height"] = float(active_doc.height)
            except Exception as e:
                print(f"Error getting document width/height from activeDocument: {e}")
                # fallback to Action Manager (may be incorrect units)
                try:
                    ...
                    print(f"Error getting document width: {e2}")
                try:
                    ...
                    print(f"Error getting document height: {e2}")
