...
from photoshop_mcp_server2.decorators import debug_tool, log_tool_call
...
def register_all_tools(
    mcp_server: FastMCP, package_name: str = "photoshop_mcp_server2.tools"
) -> dict[str, list[str]]:
...
def register_all_resources(
    mcp_server: FastMCP, package_name: str = "photoshop_mcp_server2.resources"
) -> dict[str, list[str]]:
